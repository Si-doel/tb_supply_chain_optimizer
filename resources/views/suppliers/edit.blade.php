        ...
        <form action="{{ route('suppliers.update', $supplier->sup_id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="sup_kode" name="sup_kode"
                       ...
                       value="{{ old('sup_kode', $supplier->sup_kode) }}" required>
                @error('sup_kode')
            ...
            <div class="form-group">
                ...
                <input type="text" id="sup_nama" name="sup_nama"
                       ...
                       value="{{ old('sup_nama', $supplier->sup_nama) }}" required>
                @error('sup_nama')
                    <span class="text-danger small">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="tel" id="sup_telp" name="sup_telp"
                       ...
                       value="{{ old('sup_telp', $supplier->sup_telp) }}" required>
                @error('sup_telp')
                    <span class="text-danger small">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="sup_alamat" name="sup_alamat"
                          ...
                          rows="3">{{ old('sup_alamat', $supplier->sup_alamat ?? '') }}</textarea>
                @error('sup_alamat')
                    <span class="text-danger small">{{ $message }}</span>
                @enderror
            </div>
